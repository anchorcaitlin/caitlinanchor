...
if (isequal(indexList, [1, 2, 3]) == 1) || (isequal(indexList, [1, 3, 5]) == 1) ...
    ...
    % ADDITION TO PROGRAM: PRINT OUT A MESSAGE TO THE USER REGARDING THE
    % TIME OF FLIGHT, MAXIMUM HEIGHT AND RANGE OF THE PROJECTILE. OUTPUT
    % CALCULATIONS IN A MESSAGE DIALOG BOX. 
